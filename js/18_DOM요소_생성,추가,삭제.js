  ...
  btn.addEventListener("click", (e) => {
    ...
    switch(str){
      ...
      case "prepend" : 
        ...
        // TextNode 생성
        const text1 = document.createTextNode(count); // span 안에 1 넣기
      ...
      case "before" :
        ...
        div1.className = "box"; // div 요소에 box class 추가
        div1.style.backgroundColor = "orange";
        div1.innerText = count; // div의 내용으로 count 추가
                                //TextNode 사용 안 하는 방법
        standard.before(div1); // #standard 앞쪽에 요소 추가
        break;
      ...
      case "after" :
        ...
        standard.after(div2); // #standard의 뒤쪽에 요소 추가
      break;
