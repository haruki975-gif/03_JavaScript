...
{ // 함수 정의 시작
    ...
    if(num3 === 300){
        ...
        console.log("첫 번째: num4: ", num4);
    }
    
    /* {} 블럭 끝나서 중복 사용 가능 */
    if(num3 === 300){
        let num4 = 999;
        console.log("두 번째: num4: ", num4);
    }
...
{ // 함수 정의 시작
    ...
    console.log("if 끝난 이후 fn2 값 : ", fn2); /* 변경된 fn2? / 함수 지역 변수2 */
...
function typeCheck(){
    ...
    // sumFn 호출 -> () 괄호 내 값 전달 -> 계산 결과 return -> console 출력
    console.log(sumFn(111, 987));
    console.log(sumFn(1998, 555));
