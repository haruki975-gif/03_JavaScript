/* Node 탐색 확인 */
// 문서 내에서 쿼리선택자를 이용하여 아이디가 checkBtn1인 요소를 상수 checkBtn1에 저장
const checkBtn1 = document.querySelector("#checkBtn1");

// 이벤트 : 사건, 행위, 행동
// 이벤트 리스너 : 듣는다, 이벤트를 감지한다 (이벤트 감지 시 기능 수행)
// 이벤트 핸들러 : 감지 시 수행되는 기능
// checkBtn1에서 클릭 이벤트 요소가 감지되었을 때 뒤의 핸들러를 수행하겠다.
...
checkBtn2.addEventListener("click", ()=>{
  ...
  console.log("children : ", parent.children); // li 요소만(4개)
